    ...
    public static function clientConfigPayload(): array
    {
        ...
        return [
            ...
            'endpoints' => [
                ...
                'cloud_configs' => \url('/api/client/cloud/configs/'),
                'cloud_push' => \url('/api/client/cloud/push/'),
                'cloud_pull' => \url('/api/client/cloud/pull/'),
                'groups' => \url('/api/client/groups/'),
                'family' => \url('/api/client/family/'),
                'launcher_update_check' => \url('/api/client/launcher/update-check/'),
