...
function i18n_html_dictionary(): array
{
    return [
        ...
        'Jugados o con licencia' => 'Played or licensed',
        'Juegos jugados' => 'Played games',
        'Jugado' => 'Played',
        'Guia APIs' => 'API guide',
        'GuÃ­a APIs' => 'API guide',
        'Codigos de juegos' => 'Game codes',
        'CÃ³digos de juegos' => 'Game codes',
        'Codigos de objetos' => 'Item codes',
        'CÃ³digos de objetos' => 'Item codes',
        'Repositorio del launcher' => 'Launcher repository',
        'Sincronizacion cloud' => 'Cloud sync',
        'SincronizaciÃ³n cloud' => 'Cloud sync',
        'Canjear codigo' => 'Redeem code',
        'Canjear cÃ³digo' => 'Redeem code',
